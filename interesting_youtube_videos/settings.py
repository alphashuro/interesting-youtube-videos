"""
Django settings for interesting_youtube_videos project.
...
ROOT_URLCONF = 'interesting_youtube_videos.urls'
...
WSGI_APPLICATION = 'interesting_youtube_videos.wsgi.application'
